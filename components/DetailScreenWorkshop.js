          ...
          <View style={generalStyles.contentcontainer}>
            ...
            <View style={generalStyles.informationFieldWrapper}>
                <View style={generalStyles.informationField}>
                    ...
                    Wir sind in Weihnachtsstimmung und möchten euch diese und nächste Woche zu Weihnachtsworkshops in die offene Werkstatt einladen!
                    {'\n'}Ablaufplan:
                    {'\n'}14 Uhr: Gemeinsames Kekse-Essen im Audimax
                    {'\n'}15 Uhr: Einlass Werkstatt, Eröffnungsrede von Werkstattsleitung
                    {'\n'}15.15-16.45 Uhr: Herstellung 3D-Plätzchenausstecher
                    {'\n'}16.45 Uhr: Abschlussrede
                    {'\n'}{'\n'}Erstellt von: Alina Rimal
                    </Text>
                </View>
            </View>
          </View>
          <View style={generalStyles.contentcontainerSmall}>
            <View style={generalStyles.informationField}>
              ...
              <Text style={generalStyles.informationTextPadding}>
                <Text style={textStyles.smallGreyMediumText}>Alina Rimal und </Text>
...
export default DetailScreenWorkshop;
